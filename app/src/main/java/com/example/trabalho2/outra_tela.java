...
public class outra_tela extends AppCompatActivity {
    ...
    private TextView resultado_final, status, faltas;
    private EditText p1, p2, p3, nome, disciplina, media;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String nota_11 = intent.getStringExtra(MainActivity.EXTRA_TEXT1);
